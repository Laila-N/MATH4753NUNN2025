#' Maximum Likelihood
#'
#' @param lfun a log function created separately
#' @param x list of variables
#' @param param parameters for the plot
#' @param ... does not mean excetera
#' @importFrom graphics axis points
#'
#' @returns a plot of the maximum likelihood for a specific distribution.
#' This also prints out the first maximum value, the parameter at i, yi, and the slope.
#' @export
#'
#' @examples
